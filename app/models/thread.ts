import Crypto from '@/public/images/ai-crypto.png';
import AI from '@/public/images/ai.png';
import Tools from '@/public/images/aitools.png';
import { StaticImageData } from 'next/image';

const wallPosts: {title: string, text: string, image: StaticImageData}[] = [
    {
